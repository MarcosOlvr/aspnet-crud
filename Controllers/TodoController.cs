...
namespace MyTodoApp.Controllers
{
    ...
    public class TodoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titlte,Done,CreatedAt,LastUpdateDate,User")] Todo todo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titlte,Done")] Todo todo)
        {
            if (id != todo.Id)
            {
                return NotFound();
